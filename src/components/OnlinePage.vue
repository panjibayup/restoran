            ...
            <div class="card-body" style="padding-left: 40px; padding-right: 40px">
              ...
              <form class="mt-4" v-on:submit.prevent>
                ...
                <div class="form-group" style="margin-bottom: 12px; font-weight: 500">
                  ...
                  <input type="text" class="form-control" v-model="pesan.Alamat" style="border-radius: 20px" />
                </div>
                <div class="form-group" style="margin-bottom: 12px; font-weight: 500">
                  <label for="Wa">WhatsApp :</label>
                  <input type="text" class="form-control" v-model="pesan.Wa" style="border-radius: 20px" />
                </div>

                <label for="bayar" style="font-weight: 500">Pembayaran :</label>
                <ul class="list-group">
                  <li class="list-group-item">
                    <input class="form-check-input me-1" type="checkbox" value="" id="firstCheckbox" />
                    <label class="form-check-label" for="firstCheckbox"> COD</label>
                  </li>
                  <li class="list-group-item">
                    <input class="form-check-input me-1" type="checkbox" value="" id="secondCheckbox" />
                    <label class="form-check-label" for="secondCheckbox"> DANA</label>
                  </li>
                  <li class="list-group-item">
                    <input class="form-check-input me-1" type="checkbox" value="" id="thirdCheckbox" />
                    <label class="form-check-label" for="thirdCheckbox"> Gopay</label>
                  </li>
                </ul>
  ...
  methods: {
    ...
    checkout() {
      if (this.pesan.nama && this.pesan.Alamat && this.pesan.Wa) {
        ...
        this.$toast.error("Formulir Wajib di isi", {
          type: "error",
          position: "top-right",
          duration: 3000,
          dismissible: true,
